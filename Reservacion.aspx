<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reservacion.aspx.cs" Inherits="ReservaBoletos.Reservacion" %>
	          	...
	          	<div class="col-md-6">
	          		<div class="cart-detail bg-light p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<p><asp:Button runat="server" Text="Finalizar" ID="btn_finalizar" OnClick="btn_finalizar_Click"/></p>
                                    <div>
